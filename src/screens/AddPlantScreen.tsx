...
export default function AddPlantScreen({ navigation }: any) {
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      // Auto-identify after picking image
      setTimeout(() => {
  ...
  const handleIdentify = async (uri?: string) => {
    ...
    try {
      ...
      const result = await geminiService.identifyPlant(targetUri, locationContext);
      ...
      if (confidencePercent < 0.6) {
        ...
        Alert.alert(
          ...
          [
            ...
            { text: 'Continue Anyway', onPress: () => populateForm(result) },
          ]
        );
        return;
      }
  ...
  const populateForm = (result: any) => {
    if (result.commonName) {
      ...
      setNickname(result.commonName); // Default nickname to common name
    }
  ...
  const handleSave = async () => {
    if (!nickname.trim()) {
      Alert.alert('Missing nickname', 'Please enter a nickname for your plant');
      return;
    }
        ...
        {!imageUri ? (
          ...
          <View style={styles.cameraPrompt}>
            ...
            <Text style={styles.promptText}>
              Position your plant in good lighting and capture a clear shot of the leaves
            </Text>
            <View style={styles.cameraButtons}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Text style={styles.cameraPrimaryButtonText}>Open Camera</Text>
              </TouchableOpacity>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Text style={styles.cameraSecondaryButtonText}>Choose from Gallery</Text>
              </TouchableOpacity>
            </View>
          </View>
        ) : (
            ...
            {!identified ? (
              ...
              <View style={styles.actionButtons}>
                {identifying ? (
                  ...
                  >
                    ...
                    <Text style={styles.identifyingTextLarge}>Identifying your plant</Text>
                    {userLocation && (
                      <Text style={styles.locationText}>
                        📍 {locationService.getLocationString(userLocation)}
                      </Text>
                    )}
                    <MotiView
                      from={{ opacity: 0.3 }}
                    ...
                    >
                      <Text style={styles.identifyingDotsText}>•••</Text>
                    </MotiView>
                  </MotiView>
                ) : (
                  <>
                    <TouchableOpacity
                      ...
                      activeOpacity={0.7}
                    >
                      <Text style={styles.identifyButtonText}>🔍 Try Again</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    <TouchableOpacity
                      ...
                      activeOpacity={0.7}
                    >
                      <Text style={styles.manualButtonText}>Not Sure? Enter Manually</Text>
                    </TouchableOpacity>
                  </>
                )}
              ...
              >
                ...
                >
                  ...
                  <Text style={styles.identifiedTitle}>{commonName || 'Plant Identified'}</Text>
                </MotiView>
                ...
                >
                  <Text style={styles.dateButtonText}>
                    {lastWatered.toLocaleDateString('en-US', {
                      weekday: 'short',
                      month: 'short',
                      day: 'numeric',
                      year: 'numeric',
                ...
                <View style={styles.bottomActions}>
                  <TouchableOpacity
                    ...
                    activeOpacity={0.7}
                  >
                    <Text style={styles.retakeSmallButtonText}>Retake</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
