...
import { formatDate, formatRelativeDate, addDays, isPastDue } from '../utils/dateUtils';
        ...
        >
          ...
          <View style={styles.wateringCard}>
            <View style={styles.wateringHeader}>
              <View>
                <Text style={styles.nextLabel}>Next watering</Text>
              ...
              <View style={[styles.statusIndicator, overdue && styles.statusOverdue]} />
            </View>
            ...
            <View style={styles.waterButtons}>
              ...
              >
                <Text style={styles.waterButtonTextPrimary}>Water</Text>
              </MotiPressable>
              ...
              <MotiPressable
                ...
                transition={{ type: 'timing', duration: 100 }}
              >
                <Text style={styles.waterButtonTextSecondary}>Defer</Text>
              </MotiPressable>
            </View>
          </View>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>Every {plant.wateringFrequencyDays}d</Text>
            </View>
            <View style={styles.infoRow}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>{formatDate(plant.addedDate)}</Text>
            </View>
          </View>
